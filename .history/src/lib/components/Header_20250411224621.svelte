...
<header class="top-0 z-50 mx-auto max-w-7xl md:sticky md:top-4 relative">
	<nav>
		<div
			class="flex flex-col justify-between rounded-b-lg bg-[#3D5A6C] px-4 py-2 md:m4 md:flex-row md:items-center md:rounded-xl"
		>
			...
			>
				<li>
					<button
						...
						class="fixed right-4 top-3 block p-2 text-2xl text-white md:hidden"
						on:click={() => (open = false)}
					>
						<IconClose />
					</button>
