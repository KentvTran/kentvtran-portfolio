<script lang="ts">
	...
	// import Bounded from './Bounded.svelte'; <!-- Commented out import -->

	export let settings: Content.SettingsDocument;
</script>

<!-- <Bounded as="footer" class="text-slate-600"> --> <!-- Commented out Bounded wrapper -->
	<div
...
<!-- </Bounded> --> <!-- Commented out closing tag -->