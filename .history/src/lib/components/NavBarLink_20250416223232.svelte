<script lang="ts">
	...
	let open = false;
	// definite assignment assertions — TS won’t complain these start undefined
	let navContainer!: HTMLElement;
	let highlightElement!: HTMLElement;
	// we know this will be an array of HTMLElements
