...
<header class="mx-auto max-w-7xl">
	<nav
		...
		class="sticky top-0 z-50 flex justify-center bg-white shadow-sm border border-gray-100 rounded-[32px] py-2 mx-4"
	...
	>
		...
		<div class="relative z-50 hidden md:block">
			<div class="flex items-center justify-between bg-white rounded-[32px] py-px relative">
				<div
					bind:this={cursorEl}
