...
<!-- Light positioned to cast shadow from top right -->
<Threlte.DirectionalLight 
    position={[10, 10, 0]}  <!-- X (right), Y (up), Z (forward) -->
    intensity={1.5}
    castShadow
    shadow-mapSize-width={2048}
    shadow-mapSize-height={2048}
    shadow-camera-left={-10}  <!-- Expanded shadow area -->
...
>
    ...
    <Threlte.ShadowMaterial opacity={0.021} />
</Threlte.Mesh>
