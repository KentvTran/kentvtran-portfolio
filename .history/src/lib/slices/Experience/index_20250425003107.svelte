<script lang="ts">
	...
	import type { RichTextField } from '@prismicio/client'; // Add this import
	...
	type ExperienceItem = Content.ExperienceSliceDefaultItem & {
		...
		company: string;
		title: string;
		description: RichTextField; // Changed from unknown to RichTextField
			...
			<div class="timeline">
				...
				<div class="timeline-item">
					<div class="timeline-content">
						...
						{#if item.project_link?.url && item.project_name}
							<a href={item.project_link.url} target="_blank" rel="noopener noreferrer">
								{item.project_name}
							</a>
						{/if}
					</div>
